...
const BitbucketServerApi = require('./../../src/BitbucketServerApi');
...
describe('BitbucketServerApi Unit Tests', function() {
  context('projects method', function() {
    it('standard call', function() {
      const bitbucket = new BitbucketServerApi('https://www.example.com', 'username', 'password');
